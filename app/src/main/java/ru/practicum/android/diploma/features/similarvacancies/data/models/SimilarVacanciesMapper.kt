...
class SimilarVacanciesMapper : (SimilarVacanciesResponse) -> List<VacancyShortDomainModel> {

    override fun invoke(dto: SimilarVacanciesResponse): List<VacancyShortDomainModel> {
